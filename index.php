 ...
 *---------------------------------------------------------------------
 * 
 * Encoding & timezone configuration
 */
 ...
 *---------------------------------------------------------------------
 * 
 * We define two different environments (development & production)
 * switching automatically from one to the other thanks to the IP
 ...
 *---------------------------------------------------------------------
 * 
 * We define the project structure in order to customize it easily to
 * fit your needs and is assumed to be fully compliant with the great
 * Twitter Bootstrap :
 *  /                   defined as DIR_BASE
 ...
 *---------------------------------------------------------------------
 * 
 * We need to define several constants in order to use them with the
 * template engine and get them updated quickly and easily if needed
 */
 ...
 *---------------------------------------------------------------------
 * 
 * We use the default 'slim.before' hook in order to make our life
 * easier. It's a nice, easy and quick way to pass constants to the
 * template engine. 
 */
...
$app->map('/', function () use ($app) {
    echo '/';
    //$app->render('index.html', array('last' => getLastPosts(), 'count' => getPostCount(), 'pages' => getPages(), 'posts' => getPosts()));
 ...
 *---------------------------------------------------------------------
 * 
 * Let's face it : it may ba handy to intercept (some) errors.
